...
function AddEntityDialogController(instance) {
    ...
    vm.addEntityFormGroup = vm.fb.group({
     owx_system_type: [null, [vm.validators.required]],
    });
    ...
    vm.filterOWXSystemTypes=function(value) {
        if(value!=undefined){
...
// return
  ...
  "keyFilters": [
	{"key":{"type":"ENTITY_FIELD","key":"name"},"valueType":"STRING","predicate":{"operation":"STARTS_WITH","value":{"defaultValue":vm.addEntityFormGroup.value.owx_system_type,"dynamicValue":null},"type":"STRING"}}  ],
  "latestValues": [],
  "pageLink": {
    "dynamic": true,
    "page": 0,
...
widgetContext.entityService.findEntityDataByQuery({
  "entityFilter": {
    "type": "edgeType",
    "resolveMultiple": true,
    "edgeType": "OWX-924-X86_22.04.3Ub"
  },
  "entityFields": [{
  "type": "ENTITY_FIELD",
  "key": "name"}  
    ...
    "textSearch": ""
            ...
            function (result) {
                ...
                if(result[0].data.length==0){
                    _assetName=vm.addEntityFormGroup.value.owx_system_type+"_0001"
                    _spsName="OWX-SPS_924"+"_0001"
                    _co2Name="OWX-CO2_924"+"_0001"
                    _pwName="OWX-PW_924"+"_0001"
                    _edgeName="OWX-EDGE_924"+"_0001"
                }
                else{
                    var nameArray=result[0].data[0].latest.ENTITY_FIELD.name.value.split("_")
                    var lastIndex=parseInt(nameArray[nameArray.length - 1]);
                    _assetName=vm.addEntityFormGroup.value.owx_system_type+"_"+intToFourDigitString(lastIndex+1)
                    ...
                    _spsName="OWX-SPS_924"+intToFourDigitString(spsLastIndex+1)
                    ...
                    _co2Name="OWX-CO2_924"+intToFourDigitString(co2LastIndex+1)
                    ...
                    _pwName="OWX-PW_924"+intToFourDigitString(pwLastIndex+1)
                    ...
                    _edgeName="OWX-EDGE_924"+intToFourDigitString(edgeLastIndex+1)
                }
            ...
            widgetContext.rxjs.forkJoin([assetService.saveAsset({name: _assetName,type: "OWX-D-924",label: _assetName}),
            ...
            widgetContext.entityService.edgeService.saveEdge({name: _edgeName,type: "OWX-924-X86_22.04.3Ub",label: _edgeName
                ,routingKey: guid()
